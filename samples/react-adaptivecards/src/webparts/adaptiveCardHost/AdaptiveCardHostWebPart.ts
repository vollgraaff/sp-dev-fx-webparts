...
export interface IAdaptiveCardHostWebPartProps {
  ...
  /**
   * Whether the dataSource is an array and will be cycled by Carousel component
   */
              ...
              groupFields: [
                ...
                isDataListBound &&
                  PropertyFieldListPicker("list", {
                    ...
                    disabled: false,
                    onPropertyChange: this.onPropertyPaneFieldChanged.bind(
                      this
                    ),
                    properties: this.properties,
                    context: this.context,
